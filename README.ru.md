...
Всё остаётся на устройстве. Ни аналитики, ни разрешения на сеть, ни аккаунта. Приложение общается
только с велокомпьютером по Bluetooth и с Health Connect на том же телефоне.
