...
энергия; вес, год рождения и пол берутся из «Здоровья» или из профиля в приложении. Экспорт `.fit`,
карта и графики появятся следующими изменениями. Нужен iOS 17 и новее, собирается из исходников:
